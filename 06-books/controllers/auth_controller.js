 ...
 */
 ...
 const login = async (req, res) => {
     ...
     // sign payload and get access-token (expiersIn menar att tokenen bara är giltig i 30sekunder)
     const access_token = jwt.sign(payload, process.env.ACCESS_TOKEN_SECRET, { 
        expiresIn: process.env.ACCESS_TOKEN_EXPIRES_LIFETIME || '1h',
    });
 ...
 const refresh = (req, res) => {
    // validate the refresh token (chexk signature and expity date)
    try {
